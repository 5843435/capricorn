...
(function() {
  $(function() {
    return $('#rakuten-button').on('click', function() {
      return $.ajax({
        async: true,
        url: "/rakuten/search",
        type: "GET",
        data: {
          jan: $('#user_item_id').val()
        },
        dataType: "json",
        context: this,
        success: function(data, textStatus, jqXHR) {
          if (data != null) {
            return $("#user_item_name").val(data[0].params.itemName);
          } else {
            return $("#result").css("color", "#ff0000").html("対象データが存在しません");
          }
        }
      });
    });
